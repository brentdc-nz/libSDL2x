...
struct SDL_VideoDevice
{
    ...
    int (*CreateSDLWindowFrom) (_THIS, SDL_Window * window, const void *data); // NULL on Xbox unsupported
    ...
    void *(*GL_GetProcAddress) (_THIS, const char *proc); // NUll on Xbox
